...
# new object is created called informal_greeting and it's pointed at the
# same object as greetings[:a]
informal_greeting << ' there'
# because << is a mutating method and informal_greeting and greetings[:a]
# point to the same object, the value of greetings[:a] will also be changed

puts informal_greeting  #  => "hi there"
puts greetings

# the value of greetings will also be changed
