...
#--------------------------------------------------------------
# In Ruby, what gets passed in the parameter list is not what it
# appears. Under the hood, ruby passes the object id of each item
# rather than the value of the parameter. The method internally
# stores these object id's in locally scoped (private to the method)
...
# being messed with inside of the method IS the munsters hash.
